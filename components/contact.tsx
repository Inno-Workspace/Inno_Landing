...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      {/* Ambient glow orbs */}
      <div className="absolute top-0 right-1/3 w-[500px] h-[500px] bg-cyan-500/[0.07] rounded-full blur-[120px]" />
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-teal-500/[0.07] rounded-full blur-[120px]" />

      <div className="relative z-10 container mx-auto px-6">
        <div className="mb-6 md:mb-8">
          <h2
            className="text-5xl md:text-7xl lg:text-8xl font-bold mb-3 md:mb-4 text-white"
            style={{ fontFamily: "var(--font-devil-breeze)" }}
          >
            {t("contact.title")}
          </h2>
          <p
            className="text-xl md:text-2xl lg:text-3xl max-w-3xl mb-4 text-slate-300/80"
            style={{ fontFamily: "var(--font-moshreq)" }}
          >
            {t("contact.subtitle")}
          </p>
          <p
            className="text-lg md:text-xl leading-relaxed max-w-4xl text-slate-400"
            style={{ fontFamily: "var(--font-moshreq)" }}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
          ...
          >
            ...
            <div
              ...
              style={{ background: "linear-gradient(90deg, transparent, rgba(103, 232, 249, 0.5), transparent)" }}
            ></div>
            ...
            <div className="flex-1 flex items-center justify-center py-8">
              <div className="relative">
                ...
                >
                  <svg className="w-12 h-12 md:w-14 md:h-14 text-cyan-400" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="text-center">
              ...
              <p
                className="text-sm md:text-base leading-relaxed mb-8 text-slate-400"
                style={{ fontFamily: "var(--font-moshreq)" }}
              >
          ...
          >
            ...
            <div className="space-y-6 relative">
              {/* Email Card */}
              <div
                className="flex items-start gap-5 p-5 rounded-xl transition-all duration-300 cursor-pointer group hover:border-cyan-500/30"
                style={infoCardStyle}
              >
                <div
                ...
                <div>
                  <p className="text-sm mb-2 font-semibold text-slate-400" style={{ fontFamily: "var(--font-moshreq)" }}>
                    {t("contact.info.emailLabel")}
                  </p>
                  <a className="text-lg font-bold text-white" style={{ fontFamily: "var(--font-moshreq)" }}>
                    contact@inno.sa
                  </a>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <a
                    ...
                    style={{ fontFamily: "var(--font-moshreq)", direction: "ltr", unicodeBidi: "plaintext" }}
                  >
                    +966 55 562 5068
                  </a>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white" style={{ fontFamily: "var(--font-moshreq)" }}>
