        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-8 mt-6 md:mt-8">
            ...
            <div className="text-center">
              ...
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  ...
                  <svg className="w-5 h-5 transition-transform group-hover:translate-x-1 rtl:rotate-180 rtl:group-hover:-translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="space-y-4 relative">
              ...
              >
                <div
                  className="w-11 h-11 md:w-14 md:h-14 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110"
                  style={{
                    background: "linear-gradient(135deg, #0891b2, #0d9488)",
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs md:text-sm mb-0.5 font-semibold" style={{ fontFamily: "var(--font-moshreq)", color: "#94a3b8" }}>
                    {t("contact.info.emailLabel")}
                  </p>
                  <a className="text-sm md:text-lg font-bold block truncate" style={{ fontFamily: "var(--font-moshreq)", color: "#ffffff" }}>
                    contact@inno.sa
                  </a>
                </div>
              </div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <a
                    className="text-sm md:text-lg font-bold font-system block"
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm md:text-lg font-bold" style={{ fontFamily: "var(--font-moshreq)", color: "#ffffff" }}>
