...
const translations = {
  en: {
    ...
    "plans.includes": "What's included:",
    ...
    "plans.plan1.for": "For small businesses, clinics & service companies",
    "plans.plan1.f1": "Delivery in 7–14 days",
    "plans.plan1.f2": "Modern mobile-responsive design",
    "plans.plan1.f3": "Direct WhatsApp integration",
    "plans.plan1.f4": "Speed & performance optimization",
    "plans.plan1.f5": "Professional online presence",
    ...
    "plans.plan2.for": "For companies with employees & daily operations",
    "plans.plan2.f1": "Client management",
    "plans.plan2.f2": "Invoices & billing",
    "plans.plan2.f3": "Employee management",
    "plans.plan2.f4": "Tasks & workflow tracking",
    "plans.plan2.f5": "Reports & analytics",
    "plans.plan2.f6": "Fully customized to your needs",
    ...
    "plans.plan3.for": "For clinics, salons, training centers & consultants",
    "plans.plan3.f1": "Online booking page",
    "plans.plan3.f2": "Automated reminder messages",
    "plans.plan3.f3": "Full admin dashboard",
    "plans.plan3.f4": "Reports & analytics",
    "plans.plan3.f5": "Zero missed appointments",
  ...
  ar: {
    ...
    "plans.cta": "اطلب الباقة",
    "plans.popular": "الأكثر طلباً",
    "plans.includes": "الباقة تشمل:",
    "plans.plan1.title": "موقع تعريفي احترافي",
    "plans.plan1.desc": "موقع احترافي سريع يعرض خدماتك ويجيب لك عملاء.",
    "plans.plan1.for": "للشركات الصغيرة، العيادات وشركات الخدمات",
    "plans.plan1.f1": "تسليم خلال 7–14 يوم",
    "plans.plan1.f2": "تصميم حديث متوافق مع الجوال",
    "plans.plan1.f3": "ربط واتساب مباشر",
    "plans.plan1.f4": "تحسين سرعة وأداء الموقع",
    "plans.plan1.f5": "حضور احترافي أونلاين",
    "plans.plan2.title": "نظام إدارة أعمال",
    "plans.plan2.desc": "نظام داخلي مصمم حسب طريقة شغلك بالضبط — مو قالب جاهز.",
    "plans.plan2.for": "للشركات اللي عندها موظفين وعمليات يومية",
    "plans.plan2.f1": "إدارة العملاء",
    "plans.plan2.f2": "الفواتير والمحاسبة",
    "plans.plan2.f3": "إدارة الموظفين",
    "plans.plan2.f4": "متابعة المهام وسير العمل",
    "plans.plan2.f5": "التقارير والتحليلات",
    "plans.plan2.f6": "مخصص بالكامل حسب احتياجك",
    "plans.plan3.title": "نظام حجوزات أونلاين",
    "plans.plan3.desc": "نظام حجوزات متكامل يخلّي عملاءك يحجزون أونلاين — بدون فوضى.",
    "plans.plan3.for": "للعيادات، الصالونات، مراكز التدريب والاستشاريين",
    "plans.plan3.f1": "صفحة حجز أونلاين",
    "plans.plan3.f2": "رسائل تذكير تلقائية",
    "plans.plan3.f3": "لوحة تحكم كاملة",
    "plans.plan3.f4": "تقارير وإحصائيات",
    "plans.plan3.f5": "صفر مواعيد ضائعة",
